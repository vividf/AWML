...
- **`BaseDeploymentPipeline`**: Abstract pipeline for inference
...
- **Project-specific exporters**: Custom exporters for complex models (e.g., CenterPoint)
...
All pipelines inherit from `BaseDeploymentPipeline`:
