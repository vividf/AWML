    ...
    def load_pytorch_model(
        ...
        **kwargs
        ...
        raise NotImplementedError(
            f"{self.__class__.__name__}.load_pytorch_model() must be implemented by subclasses."
        )
    ...
    def run_verification(
        ...
        **kwargs
        ...
        if needs_pytorch and not pytorch_checkpoint:
            self.logger.warning("PyTorch checkpoint path not available, but required by verification scenarios. Skipping verification.")
            return {}
