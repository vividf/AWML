...
from tools.detection3d.t4dataset_converters.t4converter import extract_nuscenes_data, extract_tier4_data
...
def extract_nuscene_sample_data(nusc: NuScenes, sample: Dict[str, Any]) -> Optional[NuSceneSampleData]:
    """
...
def get_box_attrs(nusc: NuScenes, boxes: List[Box]) -> Dict[str, List[str]]:
    ...
    for box in boxes:
        ...
        attr_names = [nusc.get("attribute", attribute_token)["name"] for attribute_token in attribute_tokens]
