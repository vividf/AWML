    ...
    if matched_object_idx is not None:
        for target_object, pairs in matched_object_idx.items():
            for idx1, idx2 in pairs:
                ...
                new_num_lidar_pts = annotations[idx1][
                    "num_lidar_pts"] + annotations[idx2]["num_lidar_pts"]
                new_num_radar_pts = annotations[idx1][
                    "num_radar_pts"] + annotations[idx2]["num_radar_pts"]
