...
def visualize_scene_scene_id(
    root_path, dataset_version, scene_id, output_dir=None, show_details=False, camera_id="CAM_FRONT"
):
    """
    ...
    for i, (frame_id, image_path, pointcloud_path) in enumerate(image_files):
        ...
        try:
            visualize_calibration_and_image(
                image_path, annotation_dir, pointcloud_path, output_path, show_details, camera_id=camera_id
            )
