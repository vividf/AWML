...
class CenterPointEvaluator(BaseEvaluator):
    ...
    Args:
        ...
        components_cfg: Optional unified components configuration (ComponentsCfg).
                       Used to get output names from backbone_head.io.outputs
    """
    ...
    def __init__(
        ...
        components_cfg: Optional[ComponentsCfg] = None,
    ):
    ...
    def _get_output_names(self) -> List[str]:
        ...
        return [out.name for out in self._components_cfg.get_component("backbone_head").io.outputs]
