...
CHECKPOINT=""
ONNX=""
OUTPUT_DIR="work_dirs/bevfusion/int8_pathb"
...
INT8_ONNX="${OUTPUT_DIR}/sparse_encoder_int8_pathb.onnx"
...
echo "      deployment/projects/bevfusion/config/deploy_config_split_int8.py \\"
echo "      ${CONFIG}"
echo ""

echo "════════════════════════════════════════════════════════════"
echo "Path B INT8 Plugin Build & Transform Complete!"
echo "════════════════════════════════════════════════════════════"
echo ""
echo "Files produced:"
