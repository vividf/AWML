...
(:mod:`deployment.projects.bevfusion.export.onnx_export_pipeline`), driven by
:mod:`deployment.projects.bevfusion.export.sparse_int8_onnx_transform`; this scheme only prepares the
