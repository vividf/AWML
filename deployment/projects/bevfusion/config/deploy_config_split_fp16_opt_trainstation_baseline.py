...
# ============================================================================
spconv_remove_trainstation = False  # baseline A/B: keep trainStation/DDS in the sparse engine
...
export = dict(
    mode="none",
    work_dir="work_dirs/bevfusion_deployment_2_7_on_board_trainstaion_baseline",
    onnx_path="work_dirs/bevfusion_deployment_2_7_on_board_trainstaion_baseline/onnx",
)
