...
# ============================================================================
checkpoint_path = "work_dirs/bevfusion/bevfusion_epoch_30_ptq_dense_only_exp1.pth"
...
export = dict(
    ...
    mode="none",
    work_dir="work_dirs/bevfusion_split_int8_deployment_dense_only_exp1",
    onnx_path="work_dirs/bevfusion_split_int8_deployment_dense_only_exp1/onnx",
)
