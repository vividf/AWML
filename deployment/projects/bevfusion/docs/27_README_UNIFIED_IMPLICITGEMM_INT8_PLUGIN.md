...
`AWML/deployment/projects/bevfusion/cpp/int8_plugin/`（`ImplicitGemmInt8`），
...
python -m deployment.projects.bevfusion.export.sparse_int8_onnx_transform \
  ...
  --deploy-cfg deployment/projects/bevfusion/config/deploy_config_split_sparse_int8_dense_int8.py \
...
python -m deployment.cli.main bevfusion \
  deployment/projects/bevfusion/config/deploy_config_split_sparse_int8_dense_int8.py \
