...
python -m deployment.cli.main bevfusion \
  deployment/projects/bevfusion/config/deploy_config_split_fp16_opt_2_8.py \
...
Fixed in `config/deploy_config_split_fp16_opt_2_8.py`:
```python
...
Applied to `config/deploy_config_split_fp16_opt_2_8.py` (`onnx_config.opset_version = 18`).
