...
| 項目 | 狀態 | 說明 |
|------|------|------|
| PTQ 腳本跑完（含 sparse 再 dense 校準順序） | **可完成** | `bevfusion_quantization.py` 已強調先 INT8 sparse 再 dense，避免 amax 對錯 BEV 分佈。 |
...
### 3.2 `deployment/quantization/bevfusion_quantization.py`（脈絡）
