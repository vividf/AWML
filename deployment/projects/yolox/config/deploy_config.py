...
#
# YOLOX is an end-to-end model, so we have onpython -m deployment.cli.main yolox deployment/projects/yolox/config/deploy_config.py projects/YOLOX_opt_elan/configs/t4dataset/YOLOX_opt-S-DynamicRecognition/yolox-s-opt-elan_960x960_300e_t4dataset.py
...
components = dict(
    model=dict(
        name="yolox_opt_elan",
        onnx_file="yolox_opt_elan.onnx",
        engine_file="yolox_opt_elan.engine",
        io=dict(
            inputs=[
                dict(name="images", shape=[1, 3, 960, 960], dtype="float32"),
            ],
            outputs=[
