...
Uses Detection2DMetricsInterface for consistent metric computation.
"""
...
class YOLOXEvaluator(BaseEvaluator):
    ...
    - Detection2DMetricsInterface integration

    Args:
        model_cfg: Model configuration.
        class_names: List of class names (optional).
        metrics_config: Optional configuration for the 2D detection metrics interface.
    ...
    def _add_to_interface(self, predictions: List[Dict], ground_truths: List[Dict]) -> None:
        """Add frame to Detection2DMetricsInterface."""
    ...
    def _build_results(
        ...
        return {
            ...
            "mAP_50": map_results.get("mAP_iou_2d_0.5", summary_dict.get("mAP", 0.0)),
    ...
    def print_results(self, results: EvalResultDict) -> None:
        ...
        if "latency" in results:
            ...
            # LatencyStats is a dataclass - use attribute access
            print(f"\nLatency Statistics:")
