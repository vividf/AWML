...
- `deployment/projects/bevfusion_l/docs/21_README_IMPLICITGEMM_FP_TRT_PLUGIN_ISSUES.md`
- `deployment/projects/bevfusion_l/docs/22_README_ONNX_SPCONV_TRT_PLUGIN_AND_INFERENCE.md`
...
1. **Sparse ONNX transform step (sparse INT8 core)**
   - File: `deployment/projects/bevfusion_l/export/sparse_int8_onnx_transform.py`
...
2. **ONNX graph fusion functions**
   - File: `deployment/projects/bevfusion_l/export/onnx_fuse_implicit_gemm_activation.py`
   - FP path:
     - `ImplicitGemm -> ReLU`
...
1. **Dense BN fusion is explicitly implemented**
   ...
   - Main entry: `deployment/projects/bevfusion_l/io/model_loader.py` (`_fuse_dense_bn`).
...
2. **Sparse BN fusion is explicitly implemented**
   ...
   - Main entries:
     - `deployment/projects/bevfusion_l/io/model_loader.py` (`_fuse_spconv_bn`)
     - `deployment/projects/bevfusion_l/quantization/spconv_int8.py` (`_fuse_spconv_bn_in_encoder`)
...
1. **Model load / quantization-prepare step**
   - File: `deployment/projects/bevfusion_l/io/model_loader.py`
...
2. **Sparse INT8 PTQ preparation step**
   - File: `deployment/projects/bevfusion_l/quantization/spconv_int8.py`
...
3. **Export/deploy config stage**
   - Files under `deployment/projects/bevfusion_l/config/*.py`
