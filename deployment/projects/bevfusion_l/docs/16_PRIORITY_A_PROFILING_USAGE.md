...
cd /workspace/deployment/projects/bevfusion_l/cpp/int8_plugin
rm -rf build
...
bash deployment/projects/bevfusion_l/benchmark/nsys_profile_sparse.sh

# 或用環境變數客製：
ENGINE=work_dirs/bevfusion_split_int8_deployment/tensorrt/bevfusion_sparse.engine \
DEPLOY_CFG=deployment/projects/bevfusion_l/config/deploy_config_split_int8.py \
