...
- `deployment/projects/bevfusion_l/export/sparse_int8_onnx_transform.py`
- `deployment/projects/bevfusion_l/pipelines/tensorrt.py`
- `deployment/projects/bevfusion_l/pipelines/bevfusion_pipeline.py`
...
`deployment/projects/bevfusion_l/export/sparse_int8_onnx_transform.py` 是 sparse INT8 INT8 的核心：
...
目錄：`deployment/projects/bevfusion_l/cpp/int8_plugin`
...
- 入口：`deployment/projects/bevfusion_l/entrypoint.py`
...
- Runner：`deployment/projects/bevfusion_l/runner.py`
