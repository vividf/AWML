...
def _load_real_sparse_inputs(
    *,
    ...
    from deployment.primitives.device import DeviceSpec  # noqa: WPS433
    from deployment.projects.bevfusion_l.io.data_loader import BEVFusionDataLoader  # noqa: WPS433
    from deployment.projects.bevfusion_l.io.model_loader import build_bevfusion_model  # noqa: WPS433
