...
from deployment.projects.bevfusion_l.export.onnx_fuse_implicit_gemm_activation import _normalize_attr
...
_LEGACY_W_AMAX_PTQ = (
    ...
    "See deployment/projects/bevfusion_l/quantization/spconv_int8.py."
)
