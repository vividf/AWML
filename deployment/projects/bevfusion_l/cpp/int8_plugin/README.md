...
本目錄實作稀疏卷積 sparse INT8 的 **`ImplicitGemmInt8`** TensorRT plugin：在 `enqueue` 內將 FP16 feature／weight 量化為 INT8，呼叫 spconv 的 `ConvGemmOps::implicit_gemm`，並以 FP16 寫回輸出。

建置方式與整體 INT8 管線說明請見：

- `deployment/projects/bevfusion_l/docs/11_int8_autoware_plugin.md`
- `deployment/projects/bevfusion_l/docs/12_int8_sparse_pipeline_ptq_onnx_trt.md`
...
python -m deployment.cli.main bevfusion   deployment/projects/bevfusion_l/config/deploy_config_split_int8.py   projects/BEVFusion/configs/t4dataset/BEVFusion-L/bevfusion_lidar_voxel_second_secfpn_30e_4xb8_j6gen2_base_120m_fx.py
