...
class QATHook(Hook):
    ...
    def before_train(self, runner) -> None:
        ...
        """
        from deployment.quantization.fusion import fuse_model_bn
        from deployment.quantization.replace import (
            attach_quant_add,
            quant_conv_module,
            quant_linear_module,
        )
    ...
    def before_train_epoch(self, runner) -> None:
        ...
        if runner.epoch == self.calibration_epoch and not self._calibrated:
            from deployment.quantization.calibration import CalibrationManager
            from deployment.quantization.utils import disable_quantization
    ...
    def after_train(self, runner) -> None:
        ...
        """
        if self._quantized:
            from deployment.quantization.utils import count_quantizers
