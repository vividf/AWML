...
@dataclass
class Detection3DMetricsConfig:
...
class Detection3DMetricsAdapter:
    """
    ...
    def __init__(
        ...
        # Initialize evaluation manager (load_ground_truth=False for deployment)
    ...
    def add_frame(
        ...
        Args:
            predictions: List of prediction dicts with keys:
                - bbox_3d: [x, y, z, w, l, h, yaw] or [x, y, z, w, l, h, yaw, vx, vy]
                - label: int (class index)
                - score: float (confidence score)
            ground_truths: List of ground truth dicts with keys:
                - bbox_3d: [x, y, z, w, l, h, yaw] or [x, y, z, w, l, h, yaw, vx, vy]
