...
def main():
    ...
    json_data = mmengine.load(_data_root + "valid/annotations_without_background.json")
    json_data["categories"] = ChessPieces
    mmengine.dump(json_data, _data_root + "valid/new_annotations_without_background.json")

    CottontailRabbits = [{"id": 1, "name": "rabbit", "supercategory": "Cottontail-Rabbit"}]
