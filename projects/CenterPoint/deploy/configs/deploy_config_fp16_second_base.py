...
checkpoint_path = "models/2_5/base/centerpoint_second_base_2_5_epoch49.pth"
...
export = dict(
    ...
    mode="both",
    # ---- Common options ----------------------------------------------------
    work_dir="work_dirs/centerpoint_fp16_second_deployment_2_5_base",
...
evaluation = dict(
    ...
    backends=dict(
        ...
        onnx=dict(
            ...
            # model_dir=None,
            model_dir="work_dirs/centerpoint_fp16_second_deployment_2_5_base/onnx/",
        ),
        # TensorRT evaluation
        tensorrt=dict(
            enabled=True,
            ...
            # engine_dir=None,
            engine_dir="work_dirs/centerpoint_fp16_second_deployment_2_5_base/tensorrt/",
        ),
    ),
)
