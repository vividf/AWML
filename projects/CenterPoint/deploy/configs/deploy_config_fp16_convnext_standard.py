...
checkpoint_path = "work_dirs/centerpoint-convnext/standard/epoch_30_standard.pth"
...
export = dict(
    ...
    mode="onnx",
    # ---- Common options ----------------------------------------------------
    work_dir="work_dirs/centerpoint-convnext/standard",
...
evaluation = dict(
    ...
    backends=dict(
        ...
        onnx=dict(
            ...
            # model_dir=None,
            model_dir="work_dirs/centerpoint_fp16_second_deployment_2_5/onnx/",
        ),
        # TensorRT evaluation
        tensorrt=dict(
            enabled=True,
            ...
            # engine_dir=None,
            engine_dir="work_dirs/centerpoint_fp16_second_deployment_2_5/tensorrt/",
        ),
    ),
)
