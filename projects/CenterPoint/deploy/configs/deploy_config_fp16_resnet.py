...
checkpoint_path = "work_dirs/centerpoint_resnet34_exp3.pth"
...
export = dict(
    ...
    mode="none",
    # ---- Common options ----------------------------------------------------
    work_dir="work_dirs/centerpoint_fp16_resnet_deployment_exp3",
...
evaluation = dict(
    ...
    backends=dict(
        ...
        onnx=dict(
            ...
            # model_dir=None,
            model_dir="work_dirs/centerpoint_fp16_resnet_deployment_exp3/onnx/",
        ),
        # TensorRT evaluation
        tensorrt=dict(
            enabled=True,
            ...
            # engine_dir=None,
            engine_dir="work_dirs/centerpoint_fp16_resnet_deployment_exp3/tensorrt/",
        ),
    ),
)
