...
runtime_io = dict(
    ...
    # info_file="data/info/t4dataset_j6gen2_base_infos_test.pkl",
...
evaluation = dict(
    ...
    backends=dict(
        ...
        onnx=dict(
            ...
            # model_dir=None,
            model_dir="work_dirs/centerpoint_deployment_fp32/onnx/",
        ),
        # TensorRT evaluation
        tensorrt=dict(
            enabled=True,
            ...
            # engine_dir=None,
            engine_dir="work_dirs/centerpoint_deployment_fp32/tensorrt/",
        ),
    ),
)
