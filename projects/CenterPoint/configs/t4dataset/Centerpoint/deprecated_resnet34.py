...
max_epochs = 30
work_dir = (
    "work_dirs/centerpoint/" + _base_.dataset_type + "/second_resnet34_secfpn_4xb16_121m_j6gen2_base_t4metricv2/"
)
...
# Start training from scratch (no pretrained CenterPoint model)
load_from = None
