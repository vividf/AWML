...
def register_quant_add_symbolic():
    ...
    try:
        from projects.CenterPoint.quantization.modules.quant_add import QuantAdd
        ...
        try:
            ...
            register_custom_op_symbolic(
                "projects.CenterPoint.quantization.modules.quant_add::QuantAdd.forward",
                quant_add_symbolic,
                opset_version=13,
            )
        except Exception:
                ...
                for opset_version in range(13, 18):
                    try:
                        sym_registry.register_op(
                            f"projects.CenterPoint.quantization.modules.quant_add::QuantAdd",
                            quant_add_symbolic,
                            "",
                            opset_version,
                        )
