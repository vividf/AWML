...
custom_imports = dict(
    imports=['projects.FRNet.frnet.datasets',
             'projects.FRNet.frnet.datasets.transforms', 'projects.FRNet.frnet.models'],
...
test_pipeline = [
    ...
    dict(
        ...
        fov_down=-30.0,
        ignore_index=16),
    dict(type='Pack3DDetInputs', keys=['points'], meta_keys=[
         'num_points', 'lidar_path', 'num_pts_feats'])
]
tta_pipeline = [
    dict(
        type='LoadPointsFromFile',
    ...
    dict(
        ...
        transforms=[[
            ...
            dict(
                ...
                keys=['points'],
                meta_keys=['num_points', 'lidar_path', 'num_pts_feats'])
        ]])
]
...
train_cfg = dict(
    type='IterBasedTrainLoop', max_iters=ITERATIONS, val_interval=VAL_INTERVAL)
val_cfg = dict()
test_cfg = dict()
