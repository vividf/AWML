...
from projects.StreamPETR.stream_petr.models.utils.misc import MLN, SELayer_Linear, inverse_sigmoid, topk_gather
...
class PETRHeadDN(AnchorFreeHead):
    ...
    def _get_target_single(self, cls_score, bbox_pred, gt_labels, gt_bboxes, gt_bboxes_ignore=None):
        ...
        assign_result = self.assigner.assign(
            bbox_pred, cls_score, gt_bboxes, gt_labels, gt_bboxes_ignore, self.match_costs, False
        )
