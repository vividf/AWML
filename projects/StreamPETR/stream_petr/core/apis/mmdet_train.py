...
from projects.StreamPETR.stream_petr.core.evaluation.eval_hooks import CustomDistEvalHook
from projects.StreamPETR.stream_petr.datasets import custom_build_dataset
from projects.StreamPETR.stream_petr.datasets.builder import build_dataloader


def custom_train_detector(
    model, dataset, cfg, distributed=False, validate=False, timestamp=None, eval_model=None, meta=None
):
    ...
    if "imgs_per_gpu" in cfg.data:
        ...
        if "samples_per_gpu" in cfg.data:
            ...
            logger.warning(
                'Automatically set "samples_per_gpu"="imgs_per_gpu"=' f"{cfg.data.imgs_per_gpu} in this experiments"
            )
    ...
    runner.register_training_hooks(
        cfg.lr_config, optimizer_config, cfg.checkpoint_config, cfg.log_config, cfg.get("momentum_config", None)
    )
