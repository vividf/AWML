...
from ..layers import ASPP, ELAN
from .csp_darknet_opt import Stem


@MODELS.register_module()
class ELANDarknet(BaseModule):
    """ELAN-Darknet backbone optimized for GPU acceleration which is applied ELAN block instead of CSP block.
    ...
    def train(self, mode=True):
        super(ELANDarknet, self).train(mode)
        self._freeze_stages()
